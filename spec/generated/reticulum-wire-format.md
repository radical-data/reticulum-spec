...
- **References:**
  - RNS/Packet.py (unpack) lines 241-272
  - RNS/Packet.py (pack) lines 176-235
- **Layout fields:**
...
- **References:**
  - RNS/Reticulum.py (HEADER_MINSIZE) lines 147-154
...
- **References:**
  - RNS/Reticulum.py (HEADER_MAXSIZE) lines 147-154
...
- **References:**
  - RNS/Packet.py (get_packed_flags) lines 168-174
  - RNS/Packet.py (unpack) lines 241-252
- **Steps:**
...
- **References:**
  - RNS/Packet.py (get_hashable_part) lines 353-359
- **Steps:**
...
- **References:**
  - RNS/Identity.py (truncated_hash) lines 247-256
  - RNS/Identity.py (full_hash) lines 238-246
- **Steps:**
...
- **References:**
  - RNS/Link.py (link_id_from_lr_packet) lines 340-346
- **Steps:**
...
- **References:**
  - RNS/Link.py (LINK_MTU_SIZE) lines 78-81
...
- **References:**
  - RNS/Link.py (MTU_BYTEMASK) lines 144-145
...
- **References:**
  - RNS/Link.py (MODE_BYTEMASK) lines 144-145
...
- **References:**
  - RNS/Link.py (signalling_bytes) lines 146-150
- **Steps:**
...
- **References:**
  - RNS/Link.py (mtu_from_lr_packet) lines 152-156
  - RNS/Link.py (mode_from_lr_packet) lines 172-176
- **Steps:**
...
- **References:**
  - RNS/Transport.py (new_header) lines 907-912
...
- **References:**
  - RNS/Reticulum.py (IFAC_SALT) lines 147-154
...
- **References:**
  - RNS/Transport.py (transmit) lines 894-928
- **Steps:**
...
- **References:**
  - RNS/Transport.py (inbound) lines 1241-1295
- **Steps:**
...
- **References:**
  - RNS/Packet.py (NONE) lines 71-92
...
- **References:**
  - RNS/Packet.py (RESOURCE) lines 71-92
...
- **References:**
  - RNS/Packet.py (RESOURCE_ADV) lines 71-92
...
- **References:**
  - RNS/Packet.py (RESOURCE_REQ) lines 71-92
...
- **References:**
  - RNS/Packet.py (RESOURCE_HMU) lines 71-92
...
- **References:**
  - RNS/Packet.py (RESOURCE_PRF) lines 71-92
...
- **References:**
  - RNS/Packet.py (RESOURCE_ICL) lines 71-92
...
- **References:**
  - RNS/Packet.py (RESOURCE_RCL) lines 71-92
...
- **References:**
  - RNS/Packet.py (CACHE_REQUEST) lines 71-92
...
- **References:**
  - RNS/Packet.py (REQUEST) lines 71-92
...
- **References:**
  - RNS/Packet.py (RESPONSE) lines 71-92
...
- **References:**
  - RNS/Packet.py (PATH_RESPONSE) lines 71-92
...
- **References:**
  - RNS/Packet.py (COMMAND) lines 71-92
...
- **References:**
  - RNS/Packet.py (COMMAND_STATUS) lines 71-92
...
- **References:**
  - RNS/Packet.py (CHANNEL) lines 71-92
...
- **References:**
  - RNS/Packet.py (KEEPALIVE) lines 71-92
...
- **References:**
  - RNS/Packet.py (LINKIDENTIFY) lines 71-92
...
- **References:**
  - RNS/Packet.py (LINKCLOSE) lines 71-92
...
- **References:**
  - RNS/Packet.py (LINKPROOF) lines 71-92
...
- **References:**
  - RNS/Packet.py (LRRTT) lines 71-92
...
- **References:**
  - RNS/Packet.py (LRPROOF) lines 71-92
...
- **References:**
  - RNS/Reticulum.py (MTU) lines 89-95
...
- **References:**
  - RNS/Reticulum.py (TRUNCATED_HASHLENGTH) lines 147-154
...
- **References:**
  - RNS/Reticulum.py (IFAC_MIN_SIZE) lines 147-154
...
- **References:**
  - RNS/Reticulum.py (MDU) lines 147-154
...
- **References:**
  - RNS/Identity.py (KEYSIZE) lines 59-89
...
- **References:**
  - RNS/Identity.py (SIGLENGTH) lines 59-89
- **Value:** {'number': 64, 'unit': 'bytes'}
...
- **References:**
  - RNS/Identity.py (HASHLENGTH) lines 59-89
...
- **References:**
  - RNS/Identity.py (RATCHETSIZE) lines 59-89
- **Value:** {'number': 32, 'unit': 'bytes'}
...
- **References:**
  - RNS/Identity.py (NAME_HASH_LENGTH) lines 59-89
...
- **References:**
  - RNS/Cryptography/Token.py (TOKEN_OVERHEAD) lines 48-52
...
- **References:**
  - RNS/Identity.py (AES128_BLOCKSIZE) lines 59-89
- **Value:** {'number': 16, 'unit': 'bytes'}
...
- **References:**
  - RNS/Resource.py (MAPHASH_LEN) lines 100-106
...
- **References:**
  - RNS/Link.py (ECPUBSIZE) lines 70-80
- **Value:** {'number': 64, 'unit': 'bytes'}
...
- **References:**
  - RNS/Destination.py (hash) lines 96-130
- **Steps:**
...
- **References:**
  - RNS/Transport.py (BROADCAST) lines 49-54
- **Value:** {'number': 0, 'unit': 'byte'}
...
- **References:**
  - RNS/Transport.py (TRANSPORT) lines 49-54
- **Value:** {'number': 1, 'unit': 'byte'}
...
- **References:**
  - RNS/Interfaces/TCPInterface.py (HDLC) lines 44-53
...
- **References:**
  - RNS/Interfaces/TCPInterface.py (KISS) lines 55-66
  - RNS/Interfaces/KISSInterface.py (KISS) lines 38-57
...
- **References:**
  - RNS/Interfaces/UDPInterface.py (UDPInterface) lines 40-46
...
- **References:**
  - RNS/Transport.py (inbound) lines 1241-1250
...
- **References:**
  - RNS/Packet.py (EXPL_LENGTH) lines 413-414
- **Layout fields:**
...
- **References:**
  - RNS/Packet.py (IMPL_LENGTH) lines 413-414
- **Layout fields:**
...
- **References:**
  - RNS/Link.py (prove) lines 371-377
- **Layout fields:**
  - signature: offset 0, length 64
...
- **References:**
  - RNS/Identity.py (encrypt) lines 668-690
- **Steps:**
...
- **References:**
  - RNS/Link.py (encrypt) lines 1191-1210
- **Steps:**
...
- **References:**
  - RNS/Identity.py (validate_announce) lines 391-424
- **Layout fields:**
...
- **References:**
  - RNS/Link.py (KEEPALIVE) lines 850-856
- **Value:** {'number': 255, 'unit': 'byte'}
...
- **References:**
  - RNS/Link.py (KEEPALIVE) lines 1151-1158
- **Value:** {'number': 254, 'unit': 'byte'}
...
- **References:**
  - RNS/Link.py (LINKCLOSE) lines 693-698
- **Layout fields:**
...
- **References:**
  - RNS/Link.py (LINKIDENTIFY) lines 469-476
- **Layout fields:**
  - public_key: offset 0, length 64
...
- **References:**
  - RNS/Channel.py (pack) lines 179-197
- **Layout fields:**
...
- **References:**
  - RNS/Transport.py (path_request_handler) lines 2646-2672
- **Layout fields:**
...
- **References:**
  - RNS/Transport.py (synthesize_tunnel) lines 2120-2132
- **Layout fields:**
  - public_key: offset 0, length 64
...
- **References:**
  - RNS/Resource.py (ResourceAdvertisement) lines 1312-1338
- **Layout fields:**
...
- **References:**
  - RNS/Resource.py (request_next) lines 918-952
- **Layout fields:**
...
- **References:**
  - RNS/Resource.py (request) lines 970-1047
- **Layout fields:**
...
- **References:**
  - RNS/Resource.py (prove) lines 739-748
- **Layout fields:**
  - resource_hash: offset 0, length 32
...
- **References:**
  - RNS/Reticulum.py (ifac_key) lines 819-826
- **Steps:**
